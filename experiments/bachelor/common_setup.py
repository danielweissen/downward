...
DEFAULT_SATISFICING_SUITE = [
    ...
    'pegsol-08-strips', 'pegsol-sat11-strips', 'philosophers',                                                                                                                                             'pipesworld-notankage', 'pipesworld-tankage', 'psr-large',                                                                                                                                             'psr-middle', 'psr-small', 'rovers', 'satellite',
...
DEFAULT_SATISFICING_SUITE_UC = [
    ...
    'miconic-simpleadl', 'movie', 'mprime', 'mystery',
    'nomystery-sat11-strips', 'nurikabe-sat18-adl',
    'organic-synthesis-sat18-strips',
    ...
    'rovers', 'satellite',
    'schedule',
    'settlers-sat18-adl', 'snake-sat18-strips',
    'storage',
    'termes-sat18-strips',
    'thoughtful-sat14-strips', 'tidybot-sat11-strips', 'tpp',
    'trucks-strips',                                                                      
