...
void TestHeuristic::write_overflow_warning() {
...
void TestHeuristic::setup_exploration_queue_state(const State &state) {
...
void TestHeuristic::relaxed_exploration() {
...
void TestHeuristic::mark_preferred_operators(
...
int TestHeuristic::compute_add_and_ff(const State &state) {
