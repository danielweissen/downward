...
void EagerSearch::print_test_statistics() const {
    if(open_list->get_evaluators()) {
        if(open_list->get_evaluators()->get_description() == "pinch_tracking") {
            ...
            utils::g_log << "mean number of q cost that have been adjusted: " << a->get_current_adjustment_mean(6) << endl;
            ...
            utils::g_log << "mean number of q cost that have been adjusted 0 times in relation to total number of q: " "0" << endl;
            utils::g_log << "mean number of q cost that have been adjusted 1 times in relation to total number of q: " << "0" << endl;
            utils::g_log << "mean number of q cost that have been adjusted 2 times in relation to total number of q: " << "0" << endl;
            utils::g_log << "mean number of q cost that have been adjusted 0 times: " << "0" << endl;
            utils::g_log << "mean number of q cost that have been adjusted 1 times: " << "0" << endl;
            utils::g_log << "mean number of q cost that have been adjusted 2 times: " << "0" << endl;
            utils::g_log << "mean number of q cost that have been adjusted: " << a->get_number_of_cost_adjustments_mean() << endl;
            utils::g_log << "total number of variables: " << a->get_total_number_of_variables() << endl;
            utils::g_log << "total number of operators: " << a->get_total_number_of_operators() << endl;
            utils::g_log << "total number of qs: " << a->get_total_number_of_q() << endl;
            utils::g_log << "mean number of q that are at some point overconsitent in relation to total number of q: " << "0" << endl;
            utils::g_log << "mean number of q that are at first underconsisten in relation to total number of q: " << "0" << endl;
            utils::g_log << "mean number of state variables that are in common between two following states in relation to total number of state variables: " << "0" << endl;
            utils::g_log << "mean number of state variables that are in common between two following states in relation to total number of propositions: " << "0" << endl;
            utils::g_log << "mean number of true state variables in relation to total number of propositions: " << "0" << endl;
            utils::g_log << "variance number of state variables that are not in common between two following states in relation to total number of state variables: " << "0" << endl;
            utils::g_log << "total number of q poped out of queue mean: " << a->get_number_out_of_queue_mean() << endl;
            utils::g_log << "total number of q poped out of queue and processed mean: " << a->get_number_out_of_queue_processed_mean() << endl;
            utils::g_log << "average number of preconditions per operator: " << a->get_average_number_of_preconditions_per_operator() << endl;
        } 
        ...
        utils::g_log << "mean number of q cost that have been adjusted: " << "-1" << endl;
